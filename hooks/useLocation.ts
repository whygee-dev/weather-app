...
const useLocation = (refreshDate: Date): { location: Coordinates | null | undefined , state: string | undefined, locationError: string } => {
    ...
    const geolocError = "Please grant location access permission or turn on your GPS in order to display weather information in your region. Alternatively, manually select your region in the \"Search for places\" section.";
